...
class SignRawTransactionsTest(PexaTestFramework):
    ...
    def witness_script_test(self):
        ...
        self.nodes[0].sendtoaddress(p2sh_p2wsh_address["address"], (POW_PAYOUT-0.001))
        ...
        spending_tx = self.nodes[0].createrawtransaction([unspent_output], {self.nodes[1].getnewaddress(): Decimal(str(POW_PAYOUT-0.002))})
