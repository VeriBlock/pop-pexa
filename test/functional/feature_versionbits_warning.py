...
class VersionBitsWarningTest(PexaTestFramework):
    ...
    def send_blocks_with_version(self, peer, numblocks, version):
        ...
        for _ in range(numblocks):
            block = create_block(self.nodes[0], tip, create_coinbase(height + 1), block_time)
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because pexad will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
