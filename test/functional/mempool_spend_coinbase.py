...
class MempoolSpendCoinbaseTest(PexaTestFramework):
    ...
    def run_test(self):
        ...
        spends_raw = [create_raw_transaction(self.nodes[0], txid, node0_address, amount=(POW_PAYOUT-0.01)) for txid in coinbase_txids]
