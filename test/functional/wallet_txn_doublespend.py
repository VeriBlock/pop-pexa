...
class TxnMallTest(PexaTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 1240 PEXA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PEXA coin each
        ...
        # Node0's balance should be starting balance, plus 50PEXA for another
        ...
        # Node0's total balance should be starting balance, plus 100PEXA for
