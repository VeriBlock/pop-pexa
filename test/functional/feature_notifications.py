...
class NotificationsTest(PexaTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/pexa/pexa/pull/9371, it might be better
            ...
            # https://github.com/pexa/pexa/pull/16624. The bug is reported
            # in issue https://github.com/pexa/pexa/issues/18325.
