...
class WalletTest(PexaTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PEXA from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 PEXA with subtract fee from amount
        ...
        # Sendmany 10 PEXA with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Pexa address
            assert_raises_rpc_error(-5, "Invalid Pexa address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Pexa address
            assert_raises_rpc_error(-5, "Invalid Pexa address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Pexa address or script", self.nodes[0].importaddress, "invalid")
