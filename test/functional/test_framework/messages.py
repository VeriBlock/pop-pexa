...
# Copyright (c) 2010-2020 The Pexa Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Pexa test framework primitive and message structures
...
COIN = 100000000  # 1 pexa in satoshis
MAX_MONEY = 17122989 * COIN
...
# Objects that map to pexad objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in pexad
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in pexad indicates these should be deserialized as blocks
