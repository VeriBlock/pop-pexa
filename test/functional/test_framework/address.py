...
ADDRESS_XCRT1_UNSPENDABLE = 'xcrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3xueyj'
ADDRESS_XCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(xcrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3xueyj)#juyq9d97'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_XCRT1_P2WSH_OP_TRUE = 'xcrt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqseac85'
...
def program_to_witness(version, program, main = False):
    ...
    return segwit_addr.encode("xc" if main else "xcrt", version, program)
