...
class ConfArgsTest(PexaTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'pexa.conf'), 'a', encoding='utf-8') as conf:
        ...
        # TODO(VeriBlock): disabled, because mainnet is disabled ATM. reenable when mainnet is reenabled.
        # with open(inc_conf_file_path, 'w', encoding='utf-8') as conf:
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "pexa.conf")
