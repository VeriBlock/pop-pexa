Contributing to Pexa Core
============================

The Pexa Core project operates an open contributor model where anyone is
...
[up for grabs](https://github.com/pexa/pexa/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Bitcoin Core PR Review Club](https://pexacore.reviews/) meeting.
...
`#pexa-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/pexa-core-dev/](http://www.erisian.com.au/pexa-core-dev/)
and [http://gnusha.org/pexa-core-dev/](http://gnusha.org/pexa-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/pexa-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to pexa-qt
...
The following applies to code changes to the Pexa Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Pexa
Network Protocol consensus changes.

Whether a pull request is merged into Pexa Core rests with the project merge
...
Patches that change Pexa consensus rules are considerably more involved than
...
Where a patch set proposes to change the Pexa consensus, it must have been
...
The project leader is the release manager for each Pexa Core release.
