...
UniValue getrawpayload(const JSONRPCRequest& request, const std::string& name)
{
    ...
    RPCHelpMan{
        ...
        {
            RPCResult{"if verbose is not set or set to false", RPCResult::Type::STR_HEX, "",
                "The serialized, hex-encoded data for 'id'"},
            RPCResult{"if verbose is set to true", RPCResult::Type::STR_HEX, "", "TODO"},
        },
        RPCExamples{
