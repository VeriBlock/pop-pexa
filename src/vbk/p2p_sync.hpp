...
#ifndef PEXA_SRC_VBK_P2P_SYNC_HPP
#define PEXA_SRC_VBK_P2P_SYNC_HPP
...
void offerPopDataToAllNodes(const util::Ref& context, const pop_t& p)
{
...
#endif //PEXA_SRC_VBK_P2P_SYNC_HPP