...
#ifndef PEXA_SRC_VBK_ENTITY_CONTEXT_INFO_CONTAINER_HPP
#define PEXA_SRC_VBK_ENTITY_CONTEXT_INFO_CONTAINER_HPP
...
#endif //PEXA_SRC_VBK_ENTITY_CONTEXT_INFO_CONTAINER_HPP
