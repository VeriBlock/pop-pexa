...
#ifndef PEXA_TEST_SCRIPTNUM10_H
#define PEXA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pexa Core 0.10.0, for cross-comparison.
 */
public:
