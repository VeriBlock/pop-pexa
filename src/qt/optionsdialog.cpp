    ...
    mapper(nullptr)
{
    ...
    ui->pexaAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->pexaAtStartup);
    ...
    ui->pexaAtStartup->setToolTip(ui->pexaAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->pexaAtStartup->setText(ui->pexaAtStartup->text().arg(PACKAGE_NAME));

    ui->openPexaConfButton->setToolTip(ui->openPexaConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PexaUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->pexaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPexaConfButton_clicked()
{
