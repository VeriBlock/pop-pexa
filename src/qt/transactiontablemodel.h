...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, PexaUnits::SeparatorStyle separators=PexaUnits::separatorStandard) const;
...
#endif // PEXA_QT_TRANSACTIONTABLEMODEL_H
