...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(PexaUnits::PEXA),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->pexaBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->pexaBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(PexaUnits::formatWithUnit(unit, balance, false, PexaUnits::separatorAlways));
    ui->labelUnconfirmed->setText(PexaUnits::formatWithUnit(unit, unconfirmedBalance, false, PexaUnits::separatorAlways));
    ui->labelImmature->setText(PexaUnits::formatWithUnit(unit, immatureBalance, false, PexaUnits::separatorAlways));
    ui->labelTotal->setText(PexaUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, PexaUnits::separatorAlways));
    ui->labelWatchAvailable->setText(PexaUnits::formatWithUnit(unit, watchOnlyBalance, false, PexaUnits::separatorAlways));
    ui->labelWatchPending->setText(PexaUnits::formatWithUnit(unit, watchUnconfBalance, false, PexaUnits::separatorAlways));
    ui->labelWatchImmature->setText(PexaUnits::formatWithUnit(unit, watchImmatureBalance, false, PexaUnits::separatorAlways));
    ui->labelWatchTotal->setText(PexaUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, PexaUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("PEXA")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the PEXA balance grid from expanding and looking terrible when asset balance is hidden
