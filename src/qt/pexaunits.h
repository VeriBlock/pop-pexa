...
#ifndef PEXA_QT_PEXAUNITS_H
#define PEXA_QT_PEXAUNITS_H
...
/** Pexa unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PexaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PexaUnits(QObject *parent);

    /** Pexa units.
      @note Source: https://en.pexa.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PEXA,
...
typedef PexaUnits::Unit PexaUnit;

#endif // PEXA_QT_PEXAUNITS_H
