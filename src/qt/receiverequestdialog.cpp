...
#include <config/pexa-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPexaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PexaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPexaURI(info));
}
