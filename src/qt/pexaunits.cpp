...
QString PexaUnits::name(int unit)
{
    switch(unit)
    {
    case PEXA: return QString("PEXA");
    case mPEXA: return QString("mPEXA");
    case uPEXA: return QString::fromUtf8("μPEXA");
...
QString PexaUnits::description(int unit)
{
    ...
    case uPEXA: return QString("Micro-Pexas (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 PexaUnits::factorAsset(int unit)
{
    switch(unit)
    {
        case 0:  return 1;
...
QString PexaUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, const int nAssetUnit)
{
...
QString PexaUnits::formatWithCustomName(QString customName, const CAmount& amount, int unit, bool plussign, SeparatorStyle separators)
{
    return format(PEXA, amount / factorAsset(MAX_ASSET_UNITS - unit), plussign, separators, unit) + QString(" ") + customName;
}
...
bool PexaUnits::assetParse(int assetUnit, const QString &value, CAmount *val_out)
{
...
QString PexaUnits::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+PexaUnits::name(unit) + ")";
    }
    return amountTitle;
}
