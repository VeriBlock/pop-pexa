...
//
//     src/qt/test/test_pexa-qt -platform xcb      # Linux
//     src/qt/test/test_pexa-qt -platform windows  # Windows
//     src/qt/test/test_pexa-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PexaUnits::formatWithUnit(unit, balance, false, PexaUnits::separatorAlways);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: pexa:")) != -1);
