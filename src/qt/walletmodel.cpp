...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl& coinControl)
{
    ...
    for (const SendCoinsRecipient &rcp : recipients)
    {
        ...
        {   // User-entered pexa address / amount:
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        for (const SendCoinsRecipient &rcp : transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal pexa:URI (pexa:123...?message=example)
...
//    questionString.append(PexaUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), oldFee));
//    questionString.append("</td></tr><tr><td>");
//    questionString.append(tr("Increase:"));
//    questionString.append("</td><td>");
//    questionString.append(PexaUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), newFee - oldFee));
//    questionString.append("</td></tr><tr><td>");
//    questionString.append(tr("New fee:"));
//    questionString.append("</td><td>");
//    questionString.append(PexaUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), newFee));
