...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pexa-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pexa-tx [options] <hex-tx> [commands]  Update hex-encoded pexa transaction\n" +
            "or:     pexa-tx [options] -create [commands]   Create hex-encoded pexa transaction\n" +
            "\n";
