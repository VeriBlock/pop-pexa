# Fuzzing Pexa Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Pexa Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/pexa/pexa/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/pexa/pexa/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/pexa/pexa/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/pexa/pexa/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`pexa-core/qa-assets`](https://github.com/pexa-core/qa-assets) repo.

To fuzz `process_message` using the [`pexa-core/qa-assets`](https://github.com/pexa-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/pexa-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`pexa-core/qa-assets`](https://github.com/pexa-core/qa-assets) repo.

Every single pull request submitted against the Pexa Core repo is automatically tested against all inputs in the [`pexa-core/qa-assets`](https://github.com/pexa-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Pexa Core more robust.
...
with certain assembly code from Pexa Core's code. See [developer notes on sanitizers](https://github.com/pexa/pexa/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Pexa Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Pexa Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Pexa Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Pexa Core using [Honggfuzz](https://github.com/google/honggfuzz):
